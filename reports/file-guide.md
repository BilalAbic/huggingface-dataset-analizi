...
| Location | Contents |
|---|---|
| `reports/dataset-technical-assessment.md` | Contributors, six figures, per-dataset strengths and weaknesses, the datasets that could not be analyzed, and the technical implementation plan |
